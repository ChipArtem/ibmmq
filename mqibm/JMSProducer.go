...
// package mqibm provides interfaces for messaging applications in the style of the Java Message Service (JMS) API.
package mqibm
...
type JMSProducer interface {
	...
	//
	// Permitted arguments to this method are DeliveryMode_PERSISTENT
	// and DeliveryMode_NON_PERSISTENT.
	...
	// DeliveryMode_PERSISTENT and DeliveryMode_NON_PERSISTENT
	GetDeliveryMode() int
