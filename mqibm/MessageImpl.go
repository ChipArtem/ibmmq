...
func (msg *MessageImpl) GetJMSDeliveryMode() int {
	...
	if mqMsgPersistence == MQPER_NOT_PERSISTENT {
		jmsPersistence = DeliveryMode_NON_PERSISTENT
	} else if mqMsgPersistence == MQPER_PERSISTENT {
		jmsPersistence = DeliveryMode_PERSISTENT
	} else {
...
func (msg *MessageImpl) SetJMSReplyTo(dest Destination) JMSException {
	...
	default:
		...
		log.Fatal(CreateJMSException("UnexpectedDestinationType", "UnexpectedDestinationType", nil))
	}
...
func (msg *MessageImpl) GetJMSReplyTo() Destination {
	var replyDest Destination
	replyDest = nil
...
func (msg *MessageImpl) SetJMSCorrelationID(correlID string) JMSException {
...
// property.
func (msg *MessageImpl) SetStringProperty(name string, value *string) JMSException {
	var retErr JMSException
	...
	if isSpecial {
		...
		if specialErr != nil {
			retErr = CreateJMSException("4125", "MQJMS4125", specialErr)
		}
		return retErr
	}
	...
	if linkedErr != nil {
		rcInt := int(linkedErr.(*MQReturn).MQRC)
...
func (msg *MessageImpl) setSpecialStringPropertyValue(name string, value *string) (bool, error) {
	...
	case "JMS_IBM_Format":
		if value != nil {
			...
			msg.mqmd.Format = MQFMT_NONE // unset
		}
	...
	case "JMSXGroupID":
		...
		if value != nil {
			...
			msg.mqmd.MsgFlags |= MQMF_MSG_IN_GROUP
		} */
...
func (msg *MessageImpl) getSpecialPropertyValue(name string) (bool, interface{}, error) {
	...
	case "JMS_IBM_Format":
		if msg.mqmd != nil && msg.mqmd.Format != MQFMT_NONE {
	...
	case "JMS_IBM_MQMD_ApplOriginData":
		if msg.mqmd != nil && msg.mqmd.ApplOriginData != MQFMT_NONE {
	...
	case "JMS_IBM_Last_Msg_In_Group":
		if msg.mqmd != nil {
			value = ((msg.mqmd.MsgFlags & MQMF_LAST_MSG_IN_GROUP) != 0)
		} else {
			value = false
		}
...
func (msg *MessageImpl) GetStringProperty(name string) (*string, JMSException) {
	...
	if err == nil {
		...
		if value != nil {
			...
			case int64:
				...
				if parseErr != nil {
					retErr = CreateJMSException(MessageImpl_PROPERTY_CONVERT_FAILED_REASON,
			...
			case float64:
				...
				valueStrPtr = &valueStr
			default:
				retErr = CreateJMSException(MessageImpl_PROPERTY_CONVERT_NOTSUPPORTED_REASON,
		...
		mqret := err.(*MQReturn)
		if mqret.MQRC == MQRC_PROPERTY_NOT_AVAILABLE {
			...
			errCode := strconv.Itoa(rcInt)
			reason := MQItoString("RC", rcInt)
			retErr = CreateJMSException(reason, errCode, mqret)
...
func (msg *MessageImpl) SetIntProperty(name string, value int) JMSException {
	var retErr JMSException
...
func (msg *MessageImpl) GetIntProperty(name string) (int, JMSException) {
...
func (msg *MessageImpl) SetDoubleProperty(name string, value float64) JMSException {
	var retErr JMSException
...
// Returns 0 if the named property is not set.
func (msg *MessageImpl) GetDoubleProperty(name string) (float64, JMSException) {
...
func (msg *MessageImpl) SetBooleanProperty(name string, value bool) JMSException {
	var retErr JMSException
...
func (msg *MessageImpl) GetBooleanProperty(name string) (bool, JMSException) {
...
func (msg *MessageImpl) PropertyExists(name string) (bool, JMSException) {
...
func (msg *MessageImpl) GetPropertyNames() ([]string, JMSException) {
...
func (msg *MessageImpl) getPropertiesInternal(name string) (bool, []string, JMSException) {
...
func (msg *MessageImpl) ClearProperties() JMSException {
